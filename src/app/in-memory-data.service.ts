  ...
  export class InMemoryDataService implements InMemoryDbService {
    createDb() {
      const movies = [
        ...
        {id:19, name: 'The Matrix', category:'Science Fiction', description:'q ', duration:'2h 15m', date:'2024-10-27', time:'18:30', hallNumber: 1, thumbnail: 'https://upload.wikimedia.org/wikipedia/en/5/50/The_Matrix_Resurrections.jpg' },
        {id:20, name: 'Blade Runner 2049', category:'Science Fiction', description:'r ',duration:'2h 15m', date:'2024-10-27', time:'18:30', hallNumber: 1,  thumbnail: 'https://upload.wikimedia.org/wikipedia/en/9/9b/Blade_Runner_2049_poster.png' },
        {id:21, name: 'Se7en', category:'Thriller', description:' s', duration:'2h 15m', date:'2024-10-27', time:'18:30', hallNumber: 1, thumbnail: 'https://upload.wikimedia.org/wikipedia/en/6/68/Seven_%28movie%29_poster.jpg' },
        {id:22, name: 'Gone Girl', category:'Thriller', description:'t ', duration:'2h 15m', date:'2024-10-27', time:'18:30', hallNumber: 1, thumbnail: 'https://upload.wikimedia.org/wikipedia/en/0/05/Gone_Girl_Poster.jpg' },
        {id:23, name: 'Shutter Island', category:'Thriller', description:'w ', duration:'2h 15m', date:'2024-10-27', time:'18:30', hallNumber: 1, thumbnail: 'https://upload.wikimedia.org/wikipedia/en/7/76/Shutterislandposter.jpg' },
        {id:24, name: 'The Last Dance', category:'Documentary', description:'x ', duration:'2h 15m', date:'2024-10-27', time:'18:30', hallNumber: 1, thumbnail: 'https://upload.wikimedia.org/wikipedia/en/a/a3/Venom_The_Last_Dance_Poster.jpg' },
        {id:25, name: 'Won\'t You Be My Neighbor?', category:'Documentary', description:'y ', duration:'2h 15m', date:'2024-10-27', time:'18:30', hallNumber: 1, thumbnail: 'https://upload.wikimedia.org/wikipedia/en/7/7d/Won%27t_You_Be_My_Neighbor%3F.png' },
        {id:26, name: '13th', category:'Documentary', description:' z', duration:'2h 15m', date:'2024-10-27', time:'18:30', hallNumber: 1, thumbnail: 'https://upload.wikimedia.org/wikipedia/en/6/6b/13th_%28film%29.png' },
        {id:27, name: 'Toy Story', category:'Animation', description:' AA', duration:'2h 15m', date:'2024-10-27', time:'18:30', hallNumber: 1, thumbnail: 'https://upload.wikimedia.org/wikipedia/en/4/4c/Toy_Story_4_poster.jpg' },
        {id:28, name: 'Spirited Away', category:'Animation', description:' AB', duration:'2h 15m', date:'2024-10-27', time:'18:30', hallNumber: 1, thumbnail: 'https://upload.wikimedia.org/wikipedia/en/d/db/Spirited_Away_Japanese_poster.png' },
        {id:29, name: 'Finding Nemo', category:'Animation', description:' AC', duration:'2h 15m', date:'2024-10-27', time:'18:30', hallNumber: 1, thumbnail: 'https://upload.wikimedia.org/wikipedia/en/2/29/Finding_Nemo.jpg' }
